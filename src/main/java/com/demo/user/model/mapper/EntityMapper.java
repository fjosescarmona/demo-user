...
public class EntityMapper {
  ...
  public UserResponseDto userEntityToUserResponseDto(
      UserEntity userEntity, List<PhoneEntity> phoneEntity) {
    return UserResponseDto.builder()
        .id(userEntity.getUserId())
        .name(userEntity.getName())
        .email(userEntity.getEmail())
        .password(userEntity.getPassword())
        .phones(phoneEntity.stream().map(this::phoneEntityToPhoneDto).collect(Collectors.toList()))
  ...
  public UserResponse userResponseDtoToUserResponse(UserResponseDto userResponseDto) {
    ...
    userResponse.phones(
        userResponseDto.getPhones().stream()
            .map(this::phoneDtoToPhone)
            .collect(Collectors.toList()));
